...
The Parent POM version and the SR Instance image tag **must match** within a deployment (currently `27.0.0-SNAPSHOT`). The persistence layer is Apache Jackrabbit Oak (Segment Node Store, JCR).
