...
public @interface DownloadLinkConfig {
    ...
    /**
     * If {@code true}, the port will be included in the download link.
     * Otherwise, no port will be included, even if it is specified in {@link DownloadLinkConfig#port()}.
    ...
    /**
     * Port which will be addressed by the download link.
     * It will be included in the link only if {@link DownloadLinkConfig#include$_$port()} is {@code true}.
