...
public class SimpleAuthorizable {
    ...
    /**
     * Grants the right to impersonate this {@link SimpleAuthorizable} to the specified {@link Authorizable}s identified
     * by their {@link AuthID}s. If the impersonation right cannot be granted to any of the specified {@link AuthID}s,
     * those will be ignored.
     *
     * @param impersonatorIDs collection of {@link AuthID}s of {@link Authorizable}s to which the impersonation right
     *                        will be granted
     ...
     *
     * @param impersonatorIDs collection of {@link AuthID}s of {@link Authorizable}s from which the impersonation right
     *                        will be revoked
    ...
    /**
     * Add the {@link Authorizable} represented by this {@link SimpleAuthorizable} to a {@link Group} identified by the
     * specified {@link AuthIDGroup}.
     *
     * @param authIDGroup {@link AuthIDGroup} identifying a {@link Group} to which the {@link Authorizable} represented
     *                    by this {@link SimpleAuthorizable} should be added to
     * @return {@code true} if in the end of the adding operation the {@link Authorizable} represented by this
     * {@link SimpleAuthorizable} is a direct (declared) member of the {@link Group} identified by the specified
    ...
    private Optional<Group> toGroup(
        ...
        AuthIDGroup authIDGroup, ResourceResolver resourceResolver
    ) {
