...
public interface StagedNode<T> {
     ...
     * @throws OccupiedJCRPathException if the {@code targetJCRPath} is occupied by some {@link Node} at the moment when
     *                                  the new {@link Node} is attempted to be saved at the same {@link JCRPath}
     */
