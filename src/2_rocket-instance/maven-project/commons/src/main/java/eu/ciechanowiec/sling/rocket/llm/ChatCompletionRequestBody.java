...
public interface ChatCompletionRequestBody extends JSON {
    ...
    /**
     * List of consecutive {@link ChatMessage}-s from a single {@link Chat} out of which a {@link ChatCompletion}
     * should be generated.
     * @return list of consecutive {@link ChatMessage}-s from a single {@link Chat} out of which
     *         a {@link ChatCompletion} should be generated
     */
