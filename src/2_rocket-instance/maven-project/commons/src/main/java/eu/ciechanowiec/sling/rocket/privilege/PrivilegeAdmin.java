...
public class PrivilegeAdmin {
     ...
     * @param privileges names of the {@link Privilege}s that should be granted;
     *                   usage of {@link PrivilegeConstants} fields is recommended
     * @return {@code true} if the operation was successful; {@code false} otherwise, i.a. when the
     *         specified {@link Privilege}s are already granted
     */
    @SneakyThrows
     ...
     * @param privileges names of the {@link Privilege}s that should be denied;
     *                   usage of {@link PrivilegeConstants} fields is recommended
     * @return {@code true} if the operation was successful; {@code false} otherwise, i.a. when the
     *         specified {@link Privilege}s are already denied
     */
    @SneakyThrows
