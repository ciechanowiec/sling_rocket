...
public final class MonthNode implements WithJCRPath, Comparable<MonthNode> {
     ...
     * <p>
     * The name of the {@link Node} follows the pattern applied to the return value of the {@link YearMonth#toString()}
     * method (e.g. {@code 2023-11} for November 2043).
     */
                ...
                .filter(
                    child -> {
                        ...
                        return Optional.ofNullable(valueMap.get(JcrConstants.JCR_PRIMARYTYPE, String.class))
                            .filter(childPrimaryType -> childPrimaryType.equals(DayNode.NT_DAY))
                            .isPresent();
                    }
