...
/**
 * A {@link File} with its original name. The original name is the name that was given to the {@link File} in the source
 * system from which this {@link File} was obtained, e.g. from the user's file system.
 *
