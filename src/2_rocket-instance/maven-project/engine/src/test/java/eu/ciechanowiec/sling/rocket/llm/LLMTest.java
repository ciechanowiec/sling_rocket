...
class LLMTest extends TestEnvironment {
    ...
    void setup() {
        ...
        llm = context.registerInjectActivateService(
            LLM.class, Map.of(
    ...
    void testCompletion() {
        ...
        assertEquals(
            "{\"id\":\"chatcmpl-AjpkS3315YWRC4AZJJ3gEYbqRISDx\",\"choices\":[{\"message\":{\"role\":\"assistant\","
                + "\"content\":\"My name is HAL 9000. How can I assist you today?\"}}],"
                + "\"created\":\"2024-12-29T15:44:04\",\"model\":\"gpt-4o-2024-08-06\","
    ...
    private static final class LLMAPI extends HttpServlet {
        ...
        protected void doPost(HttpServletRequest req, HttpServletResponse resp) {
            ...
            assertEquals(
                "{\"model\":\"gpt-839104284\",\"messages\":[{\"role\":\"system\",\"content\":\"Answer like you are "
                    + "HAL 9000.\"},{\"role\":\"user\",\"content\":\"What is your name?\"}],"
                    + "\"max_completion_tokens\":320,\"temperature\":0.8,\"frequency_penalty\":0.8,\"top_p\":0.8}",
                requestBody
            );
            String responseBody = """
                {
